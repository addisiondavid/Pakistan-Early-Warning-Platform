...
define('Core/MeshMaterial',['Util/defineProperty'], function (defineProperty) {
    ...
    */
    function MeshMaterial(options) {
        ...
        defineProperty(this, "uniUsed", defaultValue(options.uniUsed, [{
            uniName: "model",
        ...
        */
        getUniformMap: function (material, frameState) {
            ...
            uniformMap.u_normalMatrix = function () {
                return frameState.context.uni.normal;
            }
            uniformMap.u_projectionMatrix = function () {
                return frameState.context.uni.projection;
            }

            uniformMap.u_modelViewMatrix = function () {
                return frameState.context.uni.modelView;
            }
            ...
            uniformMap.modelMatrix = function () {
                return frameState.context.uni.model;
            }
            uniformMap.u_modelMatrix = function () {
                return frameState.context.uni.model;
            }
            uniformMap.u_viewMatrix = function () {
                return frameState.context.uni.view;
            }
            ...
            if (material.uniUsed && material.uniUsed.length) {
                material.uniUsed.forEach(function (item) {
                    if (!uniformMap[item.glslVarName]) {
                        if (!frameState.context.uni[item.uniName]) {
                            throw new Error(item.uniName + "不是Cesium引擎的内置对象");
                        }
                        uniformMap[item.glslVarName] = function () {
                            return frameState.context.uni[item.uniName];
                        }
                    }
                });
            }
